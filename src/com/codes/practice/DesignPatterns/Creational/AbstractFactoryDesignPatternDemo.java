...
public class AbstractFactoryDesignPatternDemo {
    ...
    public static void main(String[] args) {
        ...
        EnemyShip2Abstract theGrunt = MakeUFOs.orderTheShip("UFO");
        System.out.println(theGrunt + "\n");

        EnemyShip2Abstract theBoss = MakeUFOs.orderTheShip("UFO BOSS");
...
abstract class EnemyShipBuilding {
    ...
    protected abstract EnemyShip2Abstract makeEnemyShip(String typeOfShip);
    ...
    public EnemyShip2Abstract orderTheShip(String typeOfShip) {
        EnemyShip2Abstract theEnemyShip = makeEnemyShip(typeOfShip);
...
class UFOEnemyShipBuilding extends EnemyShipBuilding {
    ...
    protected EnemyShip2Abstract makeEnemyShip(String typeOfShip) {
        EnemyShip2Abstract theEnemyShip = null;
...
abstract class EnemyShip2Abstract {
...
class UFOEnemyShip2 extends EnemyShip2Abstract {
    ...
    void makeShip() {
        ...
        // objects to the UFOEnemyShip2 here
...
class UFOBossEnemyShip extends EnemyShip2Abstract {
