package com.codes.practice.ElevatorDemo2;
...
public class ElevatorDemo2 {
    ...
    public static void main(String args[]) {
        ...
        ExternalRequest eReq = new ExternalRequest(Direction.DOWN, 5);
        InternalRequest iReq = new InternalRequest(0);
        Request request = new Request(iReq, eReq);
    }
}
