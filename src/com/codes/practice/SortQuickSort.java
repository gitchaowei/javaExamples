...
public class SortQuickSort {
    ...
    private static void quicksort(int[] array, int lowIndex, int highIndex) {
        ...
        int pivotPointer = partition(array, lowIndex, highIndex, pivot);

        quicksort(array, lowIndex, pivotPointer - 1);
        quicksort(array, pivotPointer + 1, highIndex);
    ...
    private static int partition(int[] array, int lowIndex, int highIndex, int pivot) {
        ...
        // result after this while loop:
        // left side: less than pivot
        // right side: great pivot
        ...
        // This is different from what the video has, and fixes an issue
