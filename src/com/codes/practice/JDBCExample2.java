...
public class JDBCExample2 {
    static final String DB_URL = "jdbc:mysql://localhost/TUTORIALSPOINT";   // to be changed
    static final String USER = "guest";                                     // to be changed
    static final String PASS = "guest123";                                  // to be changed
    ...
    public static void main(String[] args) {
        // Open a connection
        // The try-with-resources Statement try () {} :
        // in Java SE 7 and later, implement the interface java.lang.AutoCloseable.
        // The try-with-resources statement ensures that each resource is closed at the end of the statement.
        //
        // prior to Java SE 7, use finally {} to close all resources
        try(
