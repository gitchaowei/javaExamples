...
public class ScrabbleSolver {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("C:\\Examples\\src\\com\\Interview\\dictionary.txt"));
    ...
    private static Map<Character, Integer> getCharacterCountMap(String letters) {
        ...
        for (int i = 0; i < letters.length(); i++) {
            ...
            lettersCountMap.put(currentChar, count + 1); //map allows unique key, update the key-value
        }
